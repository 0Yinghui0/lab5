...
class Calculations:
    ...
    def get_sum(self): return self.a + self.b
    def get_difference(self): return self.a - self.b
    def get_product(self): return self.a * self.b
    def get_quotient(self): return self.a / self.b if self.b != 0 else "Division by zero error"

TEMPLATE = """
<!DOCTYPE html>
<html>
<head><title>Lab 4 Calculator</title></head>
<body>
